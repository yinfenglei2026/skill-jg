...
- [ ] Cosign v3.0.6 installation was not completed: the pinned Windows release download remained at 0 bytes and was terminated. Signature/attestation creation and Task 4 live matrix assertions therefore remain unrun; live interoperability remains `PARTIAL`.
