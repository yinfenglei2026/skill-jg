...
- Live Harbor/Cosign attempt (2026-08-08): PARTIAL; the verified Harbor v2.15.2 offline package (SHA-256 `67517e0ba4a3f9db90731aa560dacbc0b24a0de04d5a1b428c7d32ea96656432`) was loaded locally, all nine Harbor services became healthy over disposable HTTPS, and a private project plus immutable fixture digest `sha256:e2f2891aaf186802295606ca01174caa70ea5800f1aab4a64654ab54ac71a675` were created. The pinned Cosign v3.0.6 Windows download remained at 0 bytes, so signature/attestation and production adapter matrix rows were not run. The named Compose resources, runtime secrets/certificates, Docker CA trust, and fixture material were removed; zero named containers, volumes, or networks remained.
...
2. Provide a verified Cosign v3.0.6 executable through a reliable release/download path, then continue the healthy Harbor fixture with fixed-key signature, SLSA attestation, and the gated production positive/negative matrix.
